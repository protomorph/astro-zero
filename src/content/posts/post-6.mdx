...
description: 'An Astro integration that allows you to auto-import components or other modules and access them in MDX.'
pubDate: 2024-07-01 23:05:00
image: 'https://picsum.photos/seed/integration-001/960/520'
category: 'Integration'
tags: ['astro', 'import', 'integration']
featured: true
---

## astro-auto-import

This is an Astro integration that allows you to auto-import components or other modules and access them in MDX files without importing them.
